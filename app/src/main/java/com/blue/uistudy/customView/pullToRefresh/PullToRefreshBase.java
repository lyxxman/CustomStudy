...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private onRefreshingListener<T> mOnRefreshingListener;
	...
	public  void setFooterNoMoreData(boolean isHadMore){
		setState(State.NO_MORE_DATA);
	}
	...
	public static enum Mode {
		...
		/**
		 * disalbe pull-to-Refresh View refresh and load arrow
		 * only with pull from end
		 */
		PULL_FROM_END_DISABLED_ARROW(0x5);
		/**
		...
		public boolean showFooterLoadingLayout() {
			return this == PULL_FROM_END || this == BOTH || this == MANUAL_REFRESH_ONLY||this==PULL_FROM_END_DISABLED_ARROW;
		}
	 ...
	 * @param <V>
	 */
	public static  interface onRefreshingListener<V extends View> {
	public void refreshing(final PullToRefreshBase<V> refreshView);
	}
	/**
